        ...
        <div class="input-group bootstrap-touchspin">
            ...
            {else}*}
                <input
                    ...
                    data-down-url="{$product.down_quantity_url}{if isset($product.productmega)}&id_megacart={$mega.id_megacart}{/if}"
                    data-up-url="{$product.up_quantity_url}{if isset($product.productmega)}&id_megacart={$mega.id_megacart}{/if}"
                    data-update-url="{$product.update_quantity_url}{if isset($product.productmega)}&id_megacart={$mega.id_megacart}{/if}"
                    data-product-id="{$product.id_product}"
                    {if isset($product.productmega)}data-mega-id="{$mega.id_megacart}"{/if}
                    type="text"
                    value="{if isset($product.productmega)}{$mega.quantity}{else if $product_quantity}{$product_quantity|floatval}{else}{$product.quantity}{/if}"
...
{*            {/if}*}
            <a
                ...
                rel                         = "nofollow"
                href                        = "{$product.remove_from_cart_url}{if isset($product.productmega)}&id_megacart={$mega.id_megacart}{/if}"
    ...
    <div class="col-md-2 col-xs-9 col-9 text-md-right text-xs-left text-sm-left">
        <span class="product-price">{if isset($product.productmega)}{$mega.stotalwt}{else}{$product.total}{/if}</span>
    </div>
</div>