...
<div id="field_{if $field->object neq ''}{$field->object|escape:'htmlall':'UTF-8'}_{/if}{$field->name|escape:'htmlall':'UTF-8'}"
     class="form-group col-xs-{$num_col|escape:'htmlall':'UTF-8'} col-{$num_col|escape:'htmlall':'UTF-8'} {if $field->required}required{/if} {if $cant_fields == 1}clear clearfix{/if}">
