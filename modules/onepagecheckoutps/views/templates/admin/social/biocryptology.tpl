...
<div>
    ...
    <a target="_blank" href="{$paramsBack.MODULE_DIR|escape:'htmlall':'UTF-8'}docs/guides/index_{if $paramsBack.ISO_LANG_BACKOFFICE_SHOP eq 'es'}es{else}en{/if}.html#tab_biocryptology">{l s='user guide' mod='onepagecheckoutps'}</a> >
