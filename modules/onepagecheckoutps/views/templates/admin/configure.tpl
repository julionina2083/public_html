                                                        ...
                                                        <div id="carrier_{$carrier.id_reference|escape:'htmlall':'UTF-8'}" data-id-reference="{$carrier.id_reference|escape:'htmlall':'UTF-8'}" class="carrier_container">
                                                            {foreach from=$paramsBack.PAYMENTS item='payment'}
                                                                <label class="checkbox-inline">
                                                                    <input type="checkbox" id="payment_{$payment.id_module}_{$carrier.id_reference|escape:'htmlall':'UTF-8'}" data-id-module="{$payment.id_module}" data-name-payment-module="{$payment.name|escape:'htmlall':'UTF-8'}">&nbsp;{$payment.name|escape:'htmlall':'UTF-8'}
                                                                </label>
                                                            {/foreach}
                                                        </div>
                                                    </div>
                                                                    ...
                                                                    <form class="form-horizontal" role="form">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-xs-12 col-md-9 pts-image-change-container">
                                                                                ...
                                                                                <br />
                                                                                <a href="#" id="remove-image-handler-{$payment.id_module}" class="pts-remove-image-handler col-xs-12 nopadding {if $payment.name_image eq 'no-image.png'}hidden{/if}" data-id-module="{$payment.id_module}" data-name-module="{$payment.name|escape:'htmlall':'UTF-8'}">
                                                                                    <i class="fa-pts fa-pts-remove"></i>
                                                                                    {l s='Remove image' mod='onepagecheckoutps'}</span>
                                                                                </a>
                                                                                <a href="#" id="change-image-handler-{$payment.id_module}" class="pts-change-image-handler col-xs-12 nopadding" data-id-module="{$payment.id_module}" data-name-module="{$payment.name|escape:'htmlall':'UTF-8'}">
                                                                                    <i class="fa-pts fa-pts-refresh"></i>
                                                                                    {l s='Upload' mod='onepagecheckoutps'}&nbsp;<span class="pts-change-image-name">{l s='image' mod='onepagecheckoutps'}</span>
                                                                                </a>

                                                                                <input id="file-image_payment-{$payment.id_module}" data-name-module="{$payment.name|escape:'htmlall':'UTF-8'}" type="file" class="hidden">
                                                                            </div>
                                                                            <div class="clear clearfix"></div>
                                                                        </div>
                                                                        <div class="form-group row">
                                                                            <div class="col-xs-12 col-md-6 col-lg-4 col-md-push-3">
                                                                                <button id="btn-save_image_payment-{$payment.name|escape:'htmlall':'UTF-8'}" data-id-module="{$payment.id_module}" data-name-module="{$payment.name|escape:'htmlall':'UTF-8'}" class="btn btn-primary btn-block save-image-payment has-action">
                                                                                    <i class="fa-pts fa-pts-save nohover"></i>
                                                                                    {l s='Save' mod='onepagecheckoutps'}
                                                                                </button>
                                                                            </div>
