...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_661def1b87e8d9_71666711',
...
function content_661def1b87e8d9_71666711 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
if ($_smarty_tpl->tpl_vars['current_currency']->value['iso_code'] !== $_smarty_tpl->tpl_vars['current_currency']->value['sign']) {?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['current_currency']->value['sign'], ENT_QUOTES, 'UTF-8');
}?></span>
...
if ($_smarty_tpl->tpl_vars['currency']->value['sign'] !== $_smarty_tpl->tpl_vars['currency']->value['iso_code']) {?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['currency']->value['sign'], ENT_QUOTES, 'UTF-8');
}?></a>
        </li>
      <?php
}
